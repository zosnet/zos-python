...
class Operation(GPHOperation):
    ...
    def _getklass(self, name):
        module = __import__("zosbase.operations", fromlist=["operations"])
    ...
    def __init__(self, *args, **kwargs):
        if isArgsThisClass(self, args):
            ...
            super().__init__(OrderedDict([
                ...
                # ('maintenance_collateral_cash_ratio', Uint16(kwargs["maintenance_collateral_cash_ratio"])),
                # ('maximum_short_squeeze_cash_ratio', Uint16(kwargs["maximum_short_squeeze_cash_ratio"])),
    ...
    def __init__(self, *args, **kwargs):
        ...
        if isArgsThisClass(self, args):
            ...
            super().__init__(OrderedDict([
                ...
                ('auth_key', PublicKey(kwargs["auth_key"], prefix=prefix)),
                ...
                ('num_budget', Uint16(kwargs["num_budget"])),
